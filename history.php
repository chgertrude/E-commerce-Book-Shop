        ...
        <table class="tb-view" style="text-align: center;">
               ...
               <tbody>
                   <?php
                        ...
                        INNER JOIN accounts b ON b.accountID = a.userID WHERE accountID = $aid");
                        $query->execute();
                   ...
                   ?>
                    <tr>
                        ...
                        <td><a href="list.php?uid=<?php echo $userID;?>" style="text-decoration: none ; color:#F65D4E" class="tooltip" title="View Details"><?php echo "₱".$total.".00"?></a></td>
                    </tr>
